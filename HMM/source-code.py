...
class HiddenMarkovChain:
    ...
    def create_all_chains(self, chain_length):
    ...
    def score(self, observations: list) -> float:
        ...
        score = 0
        all_chains = self.create_all_chains(len(observations))
...
a1 = ProbabilityVector({'L1': 0.90, 'L2': 0.08, 'L3': 0.01, 'L4': 0.01})
a2 = ProbabilityVector({'L1': 0.01, 'L2': 0.90, 'L3': 0.05, 'L4': 0.04})
a3 = ProbabilityVector({'L1': 0.03, 'L2': 0.02, 'L3': 0.85, 'L4': 0.10})
a4 = ProbabilityVector({'L1': 0.05, 'L2': 0.02, 'L3': 0.23, 'L4': 0.70})

b1 = ProbabilityVector({'R1': 0.01, 'R2': 0.01, 'R3': 0.20, 'R4': 0.01, 'R5': 0.30, 'R6': 0.05, 'R7': 0.01, 'R8': 0.40, 'R9': 0.01})
b2 = ProbabilityVector({'R1': 0.01, 'R2': 0.01, 'R3': 0.01, 'R4': 0.10, 'R5': 0.01, 'R6': 0.30, 'R7': 0.05, 'R8': 0.01, 'R9': 0.50})
b3 = ProbabilityVector({'R1': 0.30, 'R2': 0.20, 'R3': 0.01, 'R4': 0.10, 'R5': 0.01, 'R6': 0.30, 'R7': 0.05, 'R8': 0.02, 'R9': 0.01})
b4 = ProbabilityVector({'R1': 0.03, 'R2': 0.01, 'R3': 0.01, 'R4': 0.19, 'R5': 0.01, 'R6': 0.35, 'R7': 0.36, 'R8': 0.01, 'R9': 0.03})

A = ProbabilityMatrix({'L1': a1, 'L2': a2, 'L3': a3, 'L4': a4})
B = ProbabilityMatrix({'L1': b1, 'L2': b2, 'L3': b3, 'L4': b4})
pi = ProbabilityVector({'L1': 0, 'L2': 1, 'L3': 0, 'L4': 0})
...
model = HiddenMarkovModel.initialize(locs, 
	list(set(observables)))
model.layer.pi = pi
model.train(observables, epochs=100)
